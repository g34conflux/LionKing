        ...
        stage('Deploy') {
            ...
            steps {
                script {
                    ...
                    bat 'msdeploy -verb:sync -source:contentPath="C:\\ProgramData\\Jenkins\\.jenkins\\workspace\\ultibranchpipeline_QAForLionKing\\hakunamatata" -dest:contentPath="C:\\WebSite1"'
