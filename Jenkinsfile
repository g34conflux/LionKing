        ...
        stage('Deploy') {
            ...
            steps {
                script {
                    ...
                    bat 'msdeploy -verb:sync -source:contentPath="C:\\ProgramData\\Jenkins\\.jenkins\\workspace\\tibranchpipeline_ProdForLionKing\\hakunamatata" -dest:contentPath="C:\\DevWebSite"'
